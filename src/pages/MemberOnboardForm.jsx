...
const validateFileValue = (file, rules) => {
  if (rules?.required && !file) {
    return rules.message || "File is required";
  }

  if (file && rules?.allowedTypes && !rules.allowedTypes.includes(file.type)) {
...
const validateStep = () => {
  ...
  const validateValue = (value, field) => {
    ...
    // 🔵 TEXT / SELECT / DATE INPUT VALIDATION
    if (
      value === undefined ||
      value === null ||
    ...
    <>
      ...
      <div className="min-h-screen bg-[#f9f6f2] py-8">
        <div className="max-w-6xl mx-auto px-4 space-y-6">
          <div className="bg-gradient-to-t from-[#b58351] to-[#b6916d] rounded-lg flex justify-between items-center p-4 ">
                ...
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      rows={4}
                      className={`block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none peer resize-none ${
                ...
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent rounded-lg border appearance-none peer
                        ${
                          isSubmitted && errors?.company_pan_no_doc
                            ? "border-red-500"
                            : isSubmitted && memberFormData.company_pan_no_doc instanceof File
                            ? "border-green-500"
                            : "border-gray-300"
                        }`}
                    ...
                    className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:text-blue-600 start-1"
                    >  
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent rounded-lg border appearance-none peer
                        ${
                          isSubmitted && errors?.company_gst_no_doc
                            ? "border-red-500"
                            : isSubmitted && memberFormData.company_gst_no_doc instanceof File
                            ? "border-green-500"
                            : "border-gray-300"
                        }`}
                      onChange={handleCompanyFileChange}
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className={`bg-gray-50 block px-3 pb-3.5 pt-4 border  text-gray-900 text-sm rounded-lg w-full p-2.5 ${
                        errors?.company_type
                          ? "border-red-500"
                          : "border-gray-300"
                      }`}
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent rounded-lg border appearance-none peer
                        ${
                          isSubmitted && errors?.cancel_cheque_doc
                            ? "border-red-500"
                            : isSubmitted && memberFormData.cancel_cheque_doc instanceof File
                            ? "border-green-500"
                            : "border-gray-300"
                        }`}
                      onChange={handleCompanyFileChange}
                  ...
                  <div key={index} className="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent rounded-lg border appearance-none peer
                          ${
                            isSubmitted && errors?.director?.[index]?.user_pan_doc
                              ? "border-red-500"
                              : isSubmitted && director.user_pan_doc instanceof File
                              ? "border-green-500"
                              : "border-gray-300"
                          }`}
                      ...
                      <label
                        htmlFor="floating_outlined_director_pan_doc"
                        className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:text-blue-600 start-1"
                      >
                        Document Of PAN Card <span className="text-red-600">*</span>
                      </label>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent rounded-lg border appearance-none peer
                          ${
                            isSubmitted && errors?.director?.[index]?.user_addhar_doc
                              ? "border-red-500"
                              : isSubmitted && director.user_addhar_doc instanceof File
                              ? "border-green-500"
                              : "border-gray-300"
                          }`}
                        onChange={(e) => handleDirectorFileChange(index, e)}
                      ...
                      <label
                        htmlFor="floating_outlined_director_aadhar_doc"
                        className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 start-1"
                      >
              ...
              {currentStep === 4 && (
                <div className="grid gap-6 mt-5 mb-6 md:grid-cols-2">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <Button
                      type="button"
                      className="cursor-pointer text-white font-medium rounded-full w-10 h-10 text-lg flex items-center justify-center bg-[#b58351] hover:bg-[#4e3b30]"
                      ...
                      >
                        ...
                        {payoutBanks?.data.map((item) => {
                          return (
                            <option
                              key={item.id}
                              value={item.onboard_payout_bank}
                            >
              ...
              <div className="flex justify-between">
                <div>
                  <button
                    ...
                    className={`text-white font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mr-3 ${
                      currentStep === 1
                        ...
                        : "bg-[#b58351] hover:bg-[#4e3b30] cursor-pointer"
                    }`}
                    onClick={handlePrev}
                  >
                    &lt; Prev
                  ...
                  {currentStep < 4 && (
                    <button
                      type="button"
                      className="cursor-pointer text-white bg-[#615141] hover:bg-[#4e3b30] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                      onClick={handleNext}
                    >
                      Next &gt;
                    </button>
                ...
                <div className="flex justify-between">
                  {currentStep === 3 && (
                    <Button
                      type="button"
                      onClick={addDirector}
                      className="cursor-pointer px-4 py-2 mr-2 bg-[#615141] text-white rounded-lg hover:bg-[#4e3b30]"
                    >
                      + Add Director
                    </Button>
                  )}
